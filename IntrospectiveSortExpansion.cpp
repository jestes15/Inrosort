...
bool test_heap_sort_array() {
    int arr[] = {
            523, 6107, 9436, 1693, 8899, 2324, 9632, 1073, 1626, 4531, 9728, 9776, 6781, 7619, 3011, 4507, 3945, 9592,
            768,
            8688, 5931, 5878, 2429, 2678, 8712, 1232, 9519, 3906, 79, 4800, 1858, 7984, 5192, 6806, 1064, 6919, 1812,
            437,
            6459, 8502, 8594, 9110, 2051, 6679, 6142, 23, 4135, 8427, 4322, 2502, 4214, 63, 6201, 7039, 8131, 1227,
            4141,
            3590, 5488, 6646, 2693, 4091, 6735, 9522, 5276, 3973, 5448, 5928, 7428, 811, 6795, 7131, 7179, 7608, 3897,
            4307,
            8610, 8444, 4394, 963, 4250, 9950, 2136, 7759, 8408, 8256, 8562, 823, 7156, 3002, 4889, 7445, 8601, 822,
            8181,
            ...
            2455, 9313, 4846, 7940, 7731, 9927, 2392, 8202, 7301, 8218, 7004, 76, 7187, 5635, 5939, 2501, 6522, 7244,
            5623,
            4757, 1327, 692, 2007, 4308, 4539, 9729, 672, 5741, 6269, 1618, 6341, 5646, 654, 8543, 636, 5716, 5319,
            6119,
            2882, 5594, 9067, 174, 3883, 8034, 8434, 4800, 9901, 7880, 894, 8857, 9977, 2991, 5035, 3246, 6681, 4739,
            2768,
            5878, 5005, 5101, 5520, 1873, 7073, 1047, 618, 4154, 2963
    };
    int constexpr final_array[] = {
            3, 17, 17, 23, 63, 76, 79, 91, 174, 211, 429, 437, 523, 618, 636, 654, 672, 692, 768, 811, 822, 823, 884,
            894,
            963, 1047, 1064, 1073, 1078, 1227, 1232, 1233, 1327, 1618, 1626, 1693, 1753, 1812, 1858, 1873, 1908, 2007,
            2051,
...
bool test_swap_iterator() {
    int arr[] = {1, 2, 3};
    int constexpr arrFinal[] = {2, 1, 3};
    std::vector arrVector = {1, 2, 3};
    std::vector const arrVectorFinal = {2, 1, 3};
    std::array<int, 3> arrArray = {1, 2, 3};
    std::array<int, 3> const arrArrayFinal = {2, 1, 3};
...
bool test_partition_iterator() {
    int arr[] = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    int constexpr arrFinal[] = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::vector arrVector = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::vector const arrVectorFinal = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::array<int, 9> arrArray = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::array<int, 9> const arrArrayFinal = {1, 2, 3, 6, 3, 2, 6, 1, 6};

    std::cout << IntroSort::partition(std::begin(arr), std::end(arr), std::less<>());
    // std::cout << IntroSort::partition(arrVector.begin(), arrVector.end(), std::less<>());
    std::cout << IntroSort::partition(std::begin(arrArray), std::end(arrArray), std::less<>());
...
bool test_quicksort_iterator() {
    int arr[] = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    int constexpr arrFinal[] = {1, 1, 2, 2, 3, 3, 6, 6, 6};
    std::vector arrVector = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::vector const arrVectorFinal = {1, 1, 2, 2, 3, 3, 6, 6, 6};
    std::array<int, 9> arrArray = {1, 2, 3, 6, 3, 2, 6, 1, 6};
    std::array<int, 9> const arrArrayFinal = {1, 1, 2, 2, 3, 3, 6, 6, 6};

    IntroSort::quickSort(std::begin(arr), std::end(arr), std::less<>());
    IntroSort::quickSort(arrVector.begin(), arrVector.end(), std::less<>());
    IntroSort::quickSort(std::begin(arrArray),std::end(arrArray), std::less<>());

    assert(std::equal(std::begin(arr), std::end(arr), std::begin(arrFinal)));
    assert(std::equal(std::begin(arrVector), std::end(arrVector), std::begin(arrVectorFinal)));
    assert(std::equal(std::begin(arrArray), std::end(arrArray), std::begin(arrArrayFinal)));
...
void msg(std::string const &str, int const err) {
    ...
    ? std::cout << "\033[1;31m" << str << "\033[0m"
                << std::endl // \033[1;31m and the \033[0m turn the text between them red in the terminal
    : std::cout << "\033[1;32m" << str << "\033[0m"
                << std::endl; // \033[1;33m and the \033[0m turn the text between them green in the terminal
}
...
int main() {
    try {
        ...
        test_depth_limit_array() ? msg("test_depth_limit_array successful!", Success) : msg("test_depth_limit_array failed!", Fail);
        test_depth_limit_std_vector() ? msg("test_depth_limit_std_vector successful!", Success) : msg("test_depth_limit_std_vector failed!", Fail);
        test_depth_limit_std_array() ? msg("test_depth_limit_std_array successful!", Success) : msg("test_depth_limit_std_array failed!", Fail);
        ...
        test_partition_std_vector() ? msg("test_partition_std_vector successful!", Success) : msg("test_partition_std_vector failed!", Fail);
        test_partition_std_array() ? msg("test_partition_std_array successful!", Success) : msg("test_partition_std_array failed!", Fail);
        test_quick_sort_array() ? msg("test_quick_sort_array successful!", Success) : msg("test_quick_sort_array failed!", Fail);
        test_quick_sort_std_vector() ? msg("test_quick_sort_std_vector successful!", Success) : msg("test_quick_sort_std_vector failed!", Fail);
        test_quick_sort_std_array() ? msg("test_quick_sort_std_array successful!", Success) : msg("test_quick_sort_std_array failed!", Fail);
        test_make_heap_array() ? msg("test_make_heap_array successful!", Success) : msg("test_make_heap_array failed!", Fail);
        test_make_heap_std_vector() ? msg("test_make_heap_std_vector successful!", Success) : msg("test_make_heap_std_vector failed!", Fail);
        test_make_heap_std_array() ? msg("test_make_heap_std_array successful!", Success) : msg("test_make_heap_std_array failed!", Fail);
        test_heap_sort_array() ? msg("test_heap_sort_array successful!", Success) : msg("test_heap_sort_array failed!", Fail);
        test_heap_sort_std_vector() ? msg("test_heap_sort_std_vector successful!", Success) : msg("test_heap_sort_std_vector failed!", Fail);
        test_heap_sort_std_array() ? msg("test_heap_sort_std_array successful!", Success) : msg("test_heap_sort_std_array failed!", Fail);
        test_merge_array() ? msg("test_merge_array successful!", Success) : msg("test_merge_array failed!", Fail);
        test_merge_std_vector() ? msg("test_merge_std_vector successful!", Success) : msg("test_merge_std_vector failed!", Fail);
        test_merge_std_array() ? msg("test_merge_std_array successful!", Success) : msg("test_merge_std_array failed!", Fail);
        test_insertion_sort_array() ? msg("test_insertion_sort_array successful!", Success) : msg("test_insertion_sort_array failed!", Fail);
        test_insertion_sort_std_vector() ? msg("test_insertion_sort_std_vector successful!", Success) : msg("test_insertion_sort_std_vector failed!", Fail);
        test_insertion_sort_std_array() ? msg("test_insertion_sort_std_array successful!", Success) : msg("test_insertion_sort_std_array failed!", Fail);
        test_sort_array() ? msg("test_sort_array successful!", Success) : msg("test_sort_array failed!", Fail);
        test_sort_std_vector() ? msg("test_sort_std_vector successful!", Success) : msg("test_sort_std_vector failed!", Fail);
        test_sort_std_array() ? msg("test_sort_std_array successful!", Success) : msg("test_sort_std_array failed!", Fail);
        test_sum_iterator() ? msg("test_sum_iterator successful!", Success) : msg("test_sum_iterator failed!", Fail);
        test_swap_iterator() ? msg("test_swap_iterator successful!", Success) : msg("test_swap_iterator failed!", Fail);
        test_partition_iterator() ? msg("test_partition_iterator successful!", Success) : msg("test_partition_iterator failed!", Fail);
        test_quicksort_iterator() ? msg("test_quicksort_iterator successful!", Success) : msg("test_quicksort_iterator failed!", Fail);
    }
    catch (...) {
